...
; The consume edge stashes the raw direct base into memory, laundering the
; staged pointer past every checked consumption form.
define ptx_kernel void @staged_value_escape(ptr %runtime, ptr %direct,
                          ptr %output, ptr %stash,
...
consume:
  ...
  store ptr %sidedoor, ptr %stash, align 8
  ret void
}
